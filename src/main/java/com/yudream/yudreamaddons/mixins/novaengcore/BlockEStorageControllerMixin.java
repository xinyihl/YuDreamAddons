...
@Mixin(value = BlockEStorageController.class, remap = false)
public abstract class BlockEStorageControllerMixin extends BlockController {
    /**
     * @author xin_yi_hl
     * @reason 修复掉两个控制器
     */
    ...
    public void breakBlock(World worldIn, @Nonnull BlockPos pos, @Nonnull IBlockState state) {
        ...
        if (te instanceof EStorageController) {
            EStorageController ctrl = (EStorageController)te;

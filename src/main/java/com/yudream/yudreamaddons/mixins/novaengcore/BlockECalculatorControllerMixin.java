...
@Mixin(value = BlockECalculatorController.class, remap = false)
public abstract class BlockECalculatorControllerMixin extends BlockController {
    /**
     * @author xin_yi_hl
     * @reason 修复掉两个控制器
     */
    ...
    public void breakBlock(World worldIn, @Nonnull BlockPos pos, @Nonnull IBlockState state) {
        ...
        if (te instanceof ECalculatorController) {
            ECalculatorController ctrl = (ECalculatorController)te;
